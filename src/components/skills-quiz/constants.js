...
export const DROPDOWN_OPTION_IMPROVE_CURRENT_ROLE =
  "I want to improve at my current role";
export const DROPDOWN_OPTION_IMPROVE_CURRENT_ROLE_LABEL =
...
export const JOBS_ERROR_ALERT_MESSAGE =
  "An error occured while fetching your selected job. Please try again later.";
export const COURSES_ERROR_ALERT_MESSAGE =
  "An error occured while fetching courses. Please try again later.";
export const NO_COURSES_ALERT_MESSAGE =
  "No courses were found. Please search for another job, or click see more courses.";
export const NO_COURSES_ALERT_MESSAGE_AGAINST_SKILLS =
  "No courses were found. Please search for another job or skills.";
export const NO_PROGRAMS_ALERT_MESSAGE =
  "No programs were found. Please search for another job, or click see more courses.";
...
export const SKILLS_QUIZ_SEARCH_PAGE_MESSAGE =
  "Let edX be your guide. We combine the educational expertise of the world's leading institutions with labor market data to find the right course(s) and program(s) to help you reach your learning and professional goals.";
export const HITS_PER_PAGE = 500;
export const LOADING_NO_OF_CARDS = 9;

export const JOB_DESCRIPTION_DISCLAIMER =
  "This job description has been created by an artificial intelligence, and should be reviewed carefully.";
